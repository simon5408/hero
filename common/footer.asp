<div id="footer" class="footer" style="position: fixed; bottom: 0px;">
    	<span class="finfo">
        	<a href="images/zs.png" target="_blank" class="sicon"></a>
            <p>"汇荣" 是我司企业商号也是我司注册商标，其他任何形式出现的 "汇荣公司" 与我司无任何关系，其产品不享受我司质保及服务。我司保留追究其法律责任的权利。</p>
            <p>版权所有@江苏汇荣电气股份有限公司   苏ICP备05082751号</p>
        </span>
    </div>
	<!--
	<div class="showAd" id="showAd" style="width: 0px;">
        ...
        <a href="javascript:;" class="reShow">重播</a>
    </div>
	-->
